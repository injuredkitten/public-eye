...
public class WebUtils {
    ...
    public static HttpServletRequest getRequest() {
        ...
        return servletRequestAttributes == null ? null : (HttpServletRequest) servletRequestAttributes.getRequest();
    }
    ...
    public static HttpServletResponse getResponse() {
        ServletRequestAttributes servletRequestAttributes = getServletRequestAttributes();
        return servletRequestAttributes == null ? null : (HttpServletResponse) servletRequestAttributes.getResponse();
    }
