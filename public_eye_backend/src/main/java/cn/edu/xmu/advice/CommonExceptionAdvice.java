package cn.edu.xmu.advice;


import cn.edu.xmu.domain.R;
import cn.edu.xmu.exception.BadRequestException;
import cn.edu.xmu.exception.CommonException;
import cn.edu.xmu.exception.DbException;
import cn.edu.xmu.utils.WebUtils;
...
public class CommonExceptionAdvice {
    ...
    private ResponseEntity<R<Void>> processResponse(CommonException e){
        return ResponseEntity.status(200).body(R.error(e));
    }
}
